        ...
        <div class="row">
            <?php foreach ($ads as $ad) { ?>
                ...
                <div class="col-lg-<?=$col;?> col-md-<?=$col;?> col-sm-<?=$col;?> col-xs-12 item">
                    ...
                    <div class="image">
                        <?= !empty($ad->showPromotedLabel) ? '<div class="promoted" style="background-color: '. $ad->package->promo_label_background_color .'"><span style="color:'. $ad->package->promo_label_text_color .'">' . $ad->package->promo_label_text . '</span></div>' : '' ?>
                    ...
                    <div class="info">
                        ...
                        <a href="<?= url(['/listing/index', 'slug' => $ad->slug]); ?>" class="name">
                            <?= html_encode(mb_strtoupper($ad->title,'UTF-8')); ?>
                        </a>
