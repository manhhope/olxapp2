...
class Contact extends Base
{
     ...
     * @var string
     */
    public $keywords = 'Ads, Classified ads, sell, buy, trade, market';

    /**
     * @var string
     */
    public $description = 'Contact form for EasyAds classified ads application';
    ...
    {
        return [
            [['enableMap','country','zone','city','senderEmail','zip'],'safe'],
