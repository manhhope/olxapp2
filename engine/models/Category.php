...
class Category extends \app\models\auto\Category
{
    ...
    public function attributeLabels()
    {
        return ArrayHelper::merge(parent::attributeLabels(), [
            ...
            'status'            => t('app', 'Status'),
            'meta_keywords'     => t('app', 'Meta Keywords'),
            'meta_description'  => t('app', 'Meta Description'),
        ]);
    }
    ...
    public static function getTopCatsWithFirstLevelChildren()
    {
        ...
        ])->where(['is', 'parent_id', null])->andFilterWhere(['status'=>Category::STATUS_ACTIVE])->orderBy(['sort_order' => 'ASC'])->all();
    }
