...
class Customer extends \app\models\auto\Customer implements IdentityInterface
{
    ...
    {
        $rules = [
            [['email', 'first_name', 'last_name', 'phone', 'nickname'], 'trim'],
            ...
            [['first_name', 'last_name', 'email', 'password', 'passwordConfirm','birthdayDay', 'birthdayMonth','birthdayYear'], 'required', 'on' => self::SCENARIO_CREATE],
