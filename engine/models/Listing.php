...
class Listing extends \app\models\auto\Listing
{
    ...
    public function attributeLabels()
    {
        return ArrayHelper::merge(parent::attributeLabels(), [
            ...
            'description'   => t('app', 'Ad description'),
    ...
    {
        return $this->hasOne(ListingImage::className(), ['listing_id' => 'listing_id'])->orderBy('sort_order ASC');
    }
    ...
    public function getPriceAsCurrency($currencyCode)
    {
        ...
        $symbol = $this->getSymbolOfCurrency($currencyCode);
        ...
        return app()->formatter->asCurrency($this->price, '', [
    ...
    public function getShowPromotedLabel()
    {
        return ($this->package->promo_sign == self::TEXT_YES) ? true : false;
    }
     ...
     * @return array
     */
    public static function getListingStatusesList()
    {
        return [
