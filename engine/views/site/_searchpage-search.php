        ...
        <div class="row">
            <div class="col-lg-8 col-lg-push-2 col-md-12 col-sm-12 col-xs-12">
                <?php $form = ActiveForm::begin([
                    ...
                    'options'     => ['class' => 'searchArea search-form',]
                ]); ?>
                ...
                <div class="row">
                    ...
                    <div class="modal fade" id="modal-search-category" name="list-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                         aria-hidden="true">
                        <div class="modal-dialog add-category" role="document">
                            <div class="modal-content">
                                <div class="modal-body" data-url-search="<?= url(['/category/']); ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                        <div class="input-group">
                            <?= Html::a(t('app', 'Reset'), ['site/search'], ['class' => 'btn-as reverse']) ?>
                        </div>
                    </div>
                    <?php if ($locationDetails && options()->get('app.settings.common.disableMap', 0) == 0) { ?>
                        <div class="col-lg-3 col-lg-offset-5 col-md-3 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-12">
                            <div class="input-group">
                                <?=Html::submitButton(t('app', 'Show Map'), ['class' => 'btn-as', 'formaction' => url(['/site/search-map'])]) ?>
                            </div>
                        </div>
                    <?php } ?>
                </div>
