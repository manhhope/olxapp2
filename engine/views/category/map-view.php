...
<div class="listing-on-map">
    ...
    <div class="dropdown">
        ...
        <!-- No result found -->
        <?php if (!$listingAds) { ?>
            <span> <?= t('app', 'No result found'); ?> </span>
        <?php } ?>
        <!-- End no result found -->
    ...
    <div class="map-wrapper">
        ...
        <div class="map" id="map"
             ...
             data-url="<?=url(['/category/get-map-location']);?>" style="height: 800px; background-color: #eeebe8; filter: blur(10px);
...
<div class="container">
    <div class="row">
        <div class="mobile-advert mb10 col-xs-12 hidden-lg hidden-md hidden-sm">
            <?php app()->trigger('mobile.category.map.bottom', new \app\yii\base\Event()); ?>
        </div>
    </div>
</div>
