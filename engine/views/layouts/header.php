            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="logo">
                            <a href="<?=url(['/']);?>">
                                <img src="<?=\Yii::getAlias('@web') . options()->get('app.settings.theme.siteLogo', \Yii::getAlias('/assets/site/img/logo.png'));?>" />
                            </a>
                            ...
                            <div class="btn-group hidden-xs">
                                ...
                                <div class="dropdown-menu">
                                    <?php if (app()->customer->isGuest == false) { ?>
                                        ...
                                        <a href="<?=url(['account/conversations']);?>"><i class="fa fa-comments-o" aria-hidden="true"></i><?=t('app','Inbox');?></a>
                                    ...
                                    <?php } else { ?>
                                        <a href="<?=url(['account/join']);?>"><i class="fa fa-heart-o" aria-hidden="true"></i><?=t('app','Join');?></a>
                                        <a href="<?=url(['account/login']);?>"><i class="fa fa-user" aria-hidden="true"></i><?=t('app','Login');?></a>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="btn-group hidden-xs">
                                <a href="<?=url(['/listing/post']);?>" class="btn-as reverse"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
