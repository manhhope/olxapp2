        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="box-header hidden-lg hidden-md hidden-sm">
                <div class="text-center">
                    <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-database fa-fw']) .t('app', 'Export Favorites Ads Data '), ['export-favorite-listings-data'], ['class' => 'btn-as wide']) ?>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <ul class="list list-favorite">
                            <li class="list-head">
                                <ul>
                                    ...
                                    <li class="actions icons">'.Html::a(Html::tag('i', '', ['class' => 'fa fa-database fa-fw']) .t('app', 'Export Favorites Ads Data '), ['export-favorite-listings-data'], ['class' => 'btn-as transparent', 'data-pjax' => '0',]).'</li>
                                </ul>
                            </li>
                            <li class="list-body">
                                {items}
