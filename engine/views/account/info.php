            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="block">
                    <div class="block-heading">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <h1><?=t('app','Tell us about you');?><span class="info"><?=t('app','Please take a few moments to keep this information up to date');?>.</span></h1>
                            </div>
                    ...
                    <div class="block-body collapse" id="about-block">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <?= $form->field($modelAbout, 'nickname', [
                                        'template'      => '{input} {error}',
                                    ])->textInput([ 'placeholder' => t('app','Nickname'), 'class' => ''])->label(false); ?>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <?= $form->field($modelAbout, 'display_option', [
                                        'template'      => '{input} {error}',
                                    ])->dropDownList(\app\models\Customer::getDisplayList(),['prompt' => t('app','Display Option')])->label(false); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                ...
                <?php if (options()->get('app.settings.common.disableStore', 0) == 0) { ?>
                    <div class="block">
                        <div class="block-heading">
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <h1><?=t('app','Upgrade to store');?><span class="info"><?=t('app','You can upgrade your account to store and have your own store page');?>.</span></h1>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                ...
                <div class="block">
                    <div class="block-heading">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <h1><?=t('app','Export Data Profile');?><span class="info"><?=t('app','Export your data account');?>.</span></h1>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                <a href="#export-block" data-toggle="collapse" class="btn-trigger-collapse collapsed">
                                    <span class="closed info-title"><?= t('app', 'Open')?></span>
                                    <span class="info-title"><?= t('app', 'Close')?></span>
                                </a>
                            </div>
                    ...
                    <div class="block-body collapse" id="export-block">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <p><?=t('app','Are you sure you want to export profile data for your account?');?></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <?= Html::a(t('app', 'Export Account Data'), ['export-account-data'], ['class' => 'btn-as']); ?>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="block">
                    <div class="block-heading">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <h1><?=t('app','Delete Account');?><span class="info"><?=t('app','Delete your account');?></span></h1>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                <a href="#delete-block" data-toggle="collapse" class="btn-trigger-collapse collapsed">
                                    <span class="closed info-title"><?= t('app', 'Open')?></span>
                                    <span class="info-title"><?= t('app', 'Close')?></span>
                                </a>
                            </div>
                    ...
                    <div class="block-body collapse" id="delete-block">
                            <?php $form = ActiveForm::begin([
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <p><?=t('app','Are you sure you want to delete this account? All your data will be permanently deleted.');?></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <button type="submit" data-confirm="<?=t('app','Are you sure you want to delete this account? All your data will be permanently deleted.');?>" class="btn-as" value="Sure"><?=t('app','I\'m Sure');?></button>
                                </div>
                            </div>
                        <?php ActiveForm::end(); ?>
                    </div>
