                                                ...
                                                <?php foreach ($packages as $key=>$package) {
                                                    ...
                                                    <div class="item" data-url="<?=url(['/listing/get-summary']);?>" data-price="<?=html_encode($package->price);?>" data-country_id="<?=(int)$ad->location->country_id;?>" data-zone_id="<?=(int)$ad->location->zone_id;?>">
                                                        ...
                                                        <label for="package-<?=(int)$package->package_id;?>">
                                                                ...
                                                                <div class="description">
                                                                    <ul>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <?=t('app','Show special label');?>
                                                                            <?php if($classPromoFeaturedLabel == 'fa-check') { ?>
                                                                                <a href="javascript:;"
                                                                                   class="btn-hint pull-right"
                                                                                   data-container="body"
                                                                                   data-toggle="popover"
                                                                                   data-trigger="hover"
                                                                                   data-placement="left"
                                                                                   title="<?=t('app','Show special label');?>"
                                                                                   data-content="<?=t('app','This option will add a label [{labelText}] on the ad image.',['labelText' => $package->promo_label_text]);?>">
                                                                                    <i class="fa fa-question-circle-o" aria-hidden="true"></i>
                                                                                </a>
                                                                            <?php } ?>
                                                                        </li>
                                                            ...
                                                            <div class="buy">
                                                                <span class="btn-as large"><?=\app\helpers\CommonHelper::getPriceAsCurrency(options()->get('app.settings.common.siteCurrency', 'usd'), $package->price);?></span>
                                                            </div>
