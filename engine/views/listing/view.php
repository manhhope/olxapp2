    ...
    <div class="container">
        ...
        <div class="row">
            <div class="mb10 col-lg-8 col-lg-push-2 col-md-8 col-md-push-2 col-sm-12 hidden-xs">
                <?php app()->trigger('ad.above.gallery', new Event()); ?>
            </div>
        </div>
        <div class="row">
            <div class="mobile-advert mb10 col-xs-12 hidden-lg hidden-md hidden-sm">
                <?php app()->trigger('mobile.ad.above.gallery', new \app\yii\base\Event()); ?>
            </div>
        </div>
        ...
        <div dir="ltr" class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                ...
                <a href="#" class="btn-as hidden-xs favorite-listing" data-stats-type="<?=ListingStat::FAVORITE;?>" data-listing-id="<?=(int)$ad->listing_id;?>" data-add-msg="<?=t('app','Add to favorites');?>" data-remove-msg="<?=t('app','Remove Favorite');?>" data-favorite-url="<?=url(['/listing/toggle-favorite']);?>">
                    <?php if ($ad->isFavorite) { ?>
                        <i class="fa fa-heart" aria-hidden="true"></i> <span><?=t('app','Remove Favorite');?></span>
                    <?php } else { ?>
                        <i class="fa fa-heart-o" aria-hidden="true"></i> <span><?=t('app','Add to favorites');?></span>
        ...
        <div class="row">
            <div class="mt10 col-lg-12 col-md-12 col-sm-12 hidden-xs">
                <?php app()->trigger('ad.under.gallery', new Event()); ?>
            </div>
        </div>
        <div class="row">
            <div class="mobile-advert mb10 col-xs-12 hidden-lg hidden-md hidden-sm">
                <?php app()->trigger('mobile.ad.under.gallery', new \app\yii\base\Event()); ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <?php app()->trigger('ad.after.description', new Event()); ?>
            </div>
        </div>
    </div>
