            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="breadcrumb">
                    ...
                    <li class="actions hidden-xs">
                        <a href="<?=url(['/listing/update/', 'slug' => $ad->slug]);?>" class="btn-as danger-action"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><?=t('app','Revise');?></a>
                        <a href="<?=url(['/listing/package/', 'slug' => $ad->slug]);?>" class="btn-as"><i class="fa fa-check" aria-hidden="true"></i><?=t('app','Finish');?></a>
                    </li>
                </ul>
            </div>
        </div>
