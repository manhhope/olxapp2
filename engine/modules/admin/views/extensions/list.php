        ...
        <?= GridView::widget([
            ...
            'columns'      => [
                ...
                [
                    ...
                    'template'       => '{page} {update} {toggle} {delete}',
                    'buttons'        => [
                        'page' => function ($url, $model, $key) {
                            if ($model['status'] == 'disabled' || empty($model["pageUrl"]) || $model['update'] == true) {
                                return '';
                            }
                            return Html::a(
                                '<i class="fa fa-cog"></i>',
                                ...
                                [
                                    ...
                                    'data'  => [
                                        'pjax'      => '0',
                                        'content'   => t('app', 'View settings page'),
                                        'container' => 'body',
                                        'toggle'    => 'popover',
                                        'trigger'   => 'hover',
                                        'placement' => 'top',
                            ...
                            if ($model['update']) {
                                return Html::a(
                                    ...
                                    [
                                        ...
                                        'data' => [
                                            'pjax' => '0',
                                            'content' => t('app', 'Update extension'),
                                            'container' => 'body',
                                            'toggle' => 'popover',
                                            'trigger' => 'hover',
                                            'placement' => 'top',
