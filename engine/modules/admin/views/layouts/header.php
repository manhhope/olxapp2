...
<header class="main-header">
    <?= Html::a('<span class="logo-mini"><i class="fa fa-cogs fa-fw" aria-hidden="true"></i></span><span class="logo-lg"><i class="fa fa-cogs" aria-hidden="true"></i> Admin</span>', url(['/admin']), ['class' => 'logo']) ?>
