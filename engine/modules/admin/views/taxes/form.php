    ...
    <div class="box-body">
        ...
        <div class="taxes-form">
            ...
            <div class="row" id="taxes-select-zones-wrapper" data-url="<?=url(['taxes/get-country-zones']);?>" data-zone = <?=$model->zone_id;?>>
                ...
                <div class="col-lg-6">
                    <?= $form->field($model, 'zone_id')->dropDownList(ArrayHelper::merge(['---'],ArrayHelper::map(\app\models\Zone::getCountryZones($model->country_id), 'zone_id', 'name')),['class'=>'form-control']);?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
