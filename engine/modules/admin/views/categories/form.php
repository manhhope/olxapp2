                ...
                <div class="users-form">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            $metaKeywords = ['maxlength' => true];
                            $metaDescription = ['maxlength' => true];
                            if ($action == 'create') {
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <?= $form->field($model, 'meta_keywords')->textInput($metaKeywords) ?>
                        </div>
                        <div class="col-lg-6">
                            <?= $form->field($model, 'meta_description')->textInput($metaDescription) ?>
                        </div>
                    </div>
