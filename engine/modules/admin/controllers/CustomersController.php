...
class CustomersController extends \app\modules\admin\yii\web\Controller
{
    ...
    public function actionIndex()
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Customers'),
            'pageHeading'    => t('app', 'Customers'),
        ]);
    ...
    public function actionView($id)
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Customer {customerName}', ['customerName'=>$model->fullName]),
            'pageHeading'    => t('app', 'Customer {customerName}', ['customerName'=>$model->fullName]),
            'pageBreadcrumbs'=> [
                ['label' => t('app', 'Customers'), 'url' => ['index']] ,
                t('app', 'View'),
            ],
        ]);
    ...
    public function actionCreate()
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Create Customer'),
            'pageHeading'    => t('app', 'Create Customer'),
            'pageBreadcrumbs'=> [
                ['label' => t('app', 'Customers'), 'url' => ['index']] ,
                t('app', 'Create'),
            ],
    ...
    public function actionUpdate($id)
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Update {customerName}', ['customerName'=>$model->fullName]),
            'pageHeading'    => t('app', 'Update {customerName}', ['customerName'=>$model->fullName]),
            'pageBreadcrumbs'=> [
                ['label' => t('app', 'Customers'), 'url' => ['index']] ,
                t('app', 'Update'),
            ],
