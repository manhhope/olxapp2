...
class CategoriesController extends \app\modules\admin\yii\web\Controller
{
    ...
    public function actionIndex()
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Categories'),
            'pageHeading'    => t('app', 'Categories'),
        ]);
    ...
    public function actionView($id)
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Category {categoryName}', ['categoryName'=>$model->name]),
            'pageHeading'    => t('app', 'Category {categoryName}', ['categoryName'=>$model->name]),
            'pageBreadcrumbs'=> [
                ['label' => t('app', 'Categories'), 'url' => ['index']] ,
                t('app', 'View'),
            ],
        ]);
    ...
    public function actionCreate()
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Create Category'),
            'pageHeading'    => t('app', 'Create Category'),
            'pageBreadcrumbs'=> [
                ['label' => t('app', 'Categories'), 'url' => ['index']] ,
                t('app', 'Create'),
            ],
    ...
    public function actionUpdate($id)
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Update {categoryName}', ['categoryName'=>$model->name]),
            'pageHeading'    => t('app', 'Update {categoryName}', ['categoryName'=>$model->name]),
            'pageBreadcrumbs'=> [
                ['label' => t('app', 'Categories'), 'url' => ['index']] ,
                t('app', 'Update'),
            ],
