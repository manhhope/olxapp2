...
class PagesController extends \app\modules\admin\yii\web\Controller
{
    ...
    public function actionIndex()
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Pages'),
            'pageHeading'    => t('app', 'Pages'),
        ]);
    ...
    public function actionView($id)
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Page {pageName}', ['pageName'=>$model->title]),
            'pageHeading'    => t('app', 'Page {pageName}', ['pageName'=>$model->title]),
            'pageBreadcrumbs'=> [
                ['label' => t('app', 'Pages'), 'url' => ['index']] ,
                t('app', 'View'),
            ],
        ]);
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(request()->post()) && $model->save()) {
            ...
            $this->setViewParams([
                'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Create Page'),
                'pageHeading'    => t('app', 'Create Page'),
                'pageBreadcrumbs'=> [
                    ['label' => t('app', 'Pages'), 'url' => ['index']] ,
                    t('app', 'Create'),
                ],
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(request()->post()) && $model->save()) {
            ...
            $this->setViewParams([
                'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Update Page {pageName}', ['pageName'=>$model->title]),
                'pageHeading'    => t('app', 'Update Page {pageName}', ['pageName'=>$model->title]),
                'pageBreadcrumbs'=> [
                    ['label' => t('app', 'Pages'), 'url' => ['index']] ,
                    t('app', 'Update'),
                ],
