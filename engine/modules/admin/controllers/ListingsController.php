...
class ListingsController extends \app\modules\admin\yii\web\Controller
{
    ...
    public function actionIndex()
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Listings'),
            'pageHeading'    => t('app', 'Listings'),
        ]);
    ...
    public function actionStats($id)
    {
        ...
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Stats for {listingsName}', ['listingsName'=>$model->title]),
            'pageHeading'    => t('app', 'Stats for {listingsName}', ['listingsName'=>$model->title]),
            'pageBreadcrumbs'=> [
                ['label' => t('app', 'Listings'), 'url' => ['index']] ,
                t('app', 'Stats'),
            ],
        ]);
    ...
    {
        $this->setViewParams([
            'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Pending Listings'),
            'pageHeading'    => t('app', 'Pending Listings'),
        ]);
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(request()->post()) &&
            ...
            $this->setViewParams([
                'pageTitle'      => view_param('pageTitle') . ' | ' . t('app', 'Update {listingsName}', ['listingsName'=>$model->title]),
                'pageHeading'    => t('app', 'Update {listingsName}', ['listingsName'=>$model->title]),
                'pageBreadcrumbs'=> [
                    ['label' => t('app', 'Listings'), 'url' => ['index']] ,
                    t('app', 'Update'),
                ],
