...
class DateTimeHelper
{
     ...
     * @return array
     */
    public static function getStaticMonths()
    {
        return [
            '01' => t('app','January'),
            '02' => t('app','February'),
     ...
     * @return array
     */
    public static function getStaticBirthdayYears()
    {
        $startPoint = date('Y') - (int)options()->get('app.settings.common.allowedAge', 18);
        $endPoint = $startPoint - 60;
        $yearsArray = [];
     ...
     * @return array
     */
    public static function getStaticMonthDays()
    {
        $daysArray = [];
        for($i=1;$i<32;$i++) {
            $daysArray[$i] = $i;
     ...
     * @return array
     */
    public static function getYears($startYear, $limit = 20)
    {
        $years = [];
        $endPoint = $startYear + $limit;
        for($i=$startYear;$i < $endPoint;$i++){
            $years[$i] = $i;
        }
        return $years;
    }
