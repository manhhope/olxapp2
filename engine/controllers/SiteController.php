...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $this->setViewParams([
            ...
            'pageMetaDescription'       => options()->get('app.settings.common.siteDescription', 'EasyAds Classified Ads application'),
    ...
    public function actionContact()
    {
        ...
        $this->setViewParams([
            ...
            'pageMetaDescription'       => options()->get('app.content.contact.description', 'Contact form for EasyAds classified ads application'),
